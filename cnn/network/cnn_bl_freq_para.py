...
class cnn_bl_freq_para(object):
    ...
    def __init__(self):
        ...
        self.l01_pool_stride    = [1,1,2,1]
        self.l01_pool_ksize     = [1,1,2,1]
        #drop
        ...
        self.l02_pool_stride    = [1,1,2,1]
        self.l02_pool_ksize     = [1,1,2,1]
        #drop
        ...
        self.l03_pool_stride    = [1,1,2,1]
        self.l03_pool_ksize     = [1,1,2,1]
        #drop
        ...
        self.l04_pool_stride    = [1,1,16,1]
        self.l04_pool_ksize     = [1,1,16,1]
        #drop
